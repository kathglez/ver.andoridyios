...
function loadTimeline(type) {
    ...
    if(type === "android") {
        timelineData = [
            ...
            { title:"Android 2.0 Eclair", year:"2009", desc:"Mejoró la búsqueda y la experiencia de navegación al introducir Google Maps Navigation, que proporcionaba navegación paso a paso. También incluyó soporte para pantallas más grandes y de mayor resolución, lo que permitió una mejor visualización de las aplicaciones. Además, los dispositivos Android empezaron a soportar múltiples cuentas de correo, lo que mejoró la experiencia de usuario para quienes gestionaban varios servicios de correo electrónico en su dispositivo. Esta versión también optimizó el rendimiento y la estabilidad del sistema.", img:"imagenes/version2.0.png" },
            { title:"Android 3.0 Honeycomb", year:"2011", desc:"Fue la primera versión diseñada específicamente para tabletas. Con una interfaz totalmente renovada. Esta versión también mejoró la multitarea, permitiendo a los usuarios gestionar varias aplicaciones abiertas de forma más eficiente. La optimización para pantallas grandes y la introducción de gráficos mejorados permitió que las tabletas Android pudieran competir con dispositivos similares como el iPad. Además, esta versión incluyó un sistema de widgets más avanzados, que aprovechaban mejor el espacio disponible en la pantalla.", img:"imagenes/version3.0.png" },
            { title:"Android 4.0 Ice Cream Sandwich", year:"2011", desc:"Unificó la experiencia de usuario entre smartphones y tabletas, creando un diseño común. Introdujo la navegación por gestos, eliminando los botones físicos y creando una experiencia más fluida y moderna. También incorporó desbloqueo facial, una función innovadora para la seguridad en ese momento. Mejoró significativamente las capacidades de la cámara, incluyendo la grabación de video en alta definición y el modo panorámico.", img:"imagenes/version4.0.png" },
