...
function loadTimeline(type) {
    ...
    if(type === "android") {
        timelineData = [
            ...
            { title:"Android 2.0 Eclair", year:"2009", desc:"Mejoró la búsqueda y la experiencia de navegación al introducir Google Maps Navigation, que proporcionaba navegación paso a paso. También mejoró considerablemente la experiencia del usuario con soporte para múltiples cuentas, navegación GPS gratuita paso a paso, mejoras en cámara (flash y zoom digital) y mayor velocidad del sistema..", img:"imagenes/version2.0.png" },
